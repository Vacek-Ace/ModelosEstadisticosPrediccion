...
# Crear un data frame
data <- data.frame(
  puntuacion = c(silencioso_tradicional, silencioso_moderno, ruido_tradicional, ruido_moderno),
...
# Crear un data frame
data <- data.frame(
  puntuacion = c(tradicional_libro, tradicional_video, tradicional_software, tradicional_sin_material,
...
wilcox.test(data[data$metodo=="Moderno",]$puntuacion,
            data[data$metodo=="Tradicional",]$puntuacion, alternative = "two.sided")
```
...
rendimiento <- c(78, 82, 81, 85, 87, 88, 72, 75, 74, 80, 82, 83, 65, 68, 66, 60, 62, 61)
...
anova_result <- aov(Rendimiento ~ Combustible + Temperatura + Presión +Combustible*Temperatura+Combustible*Presión+Presión*Temperatura
                    , data = data)
