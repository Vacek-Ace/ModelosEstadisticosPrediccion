...
incumplen algunas de las suposiciones, algunas opciones básicas
son:
  1. Abandonar el modelo de regresión y desarrollar otro más
apropiado, según las suposiciones incumplidas.
  2. Emplear alguna transformación de los datos de forma que el
modelo de regresión sea válido para los datos transformados.
---
