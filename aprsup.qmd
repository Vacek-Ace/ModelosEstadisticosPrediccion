...
| Regresión de Poisson | Posisson             | Log               | Cuantitativas y Cualitativas   |
...
En la salida tenemos algunas de las medidas de rendimiento estudiadas en el @sec-eval. Sin embargo, no aparece el $F_1-score$, media harmónica de la Precisión y la Recuperación. En cualquier caso, es fácil de programar:
